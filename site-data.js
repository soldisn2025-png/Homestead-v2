    ...
    pages: {
      ...
      en: {
        ...
        nav: [
          ...
          { href: "#move-in", label: "How Move-In Works" },
          { href: "#faq", label: "FAQ" },
          { href: "#contact", label: "Contact" },
        ],
        sections: ["hero", "concept", "gallery", "included", "process", "location", "faq", "contact"],
        hero: {
        ...
        faq: {
          ...
          items: [
            ...
            { q: "How do I reserve a room?", a: "Contact us first, confirm your dates, receive a payment link by email or WhatsApp, and then pay the refundable incidental deposit and monthly rent by card." },
